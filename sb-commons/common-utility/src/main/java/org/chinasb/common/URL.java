...
import org.chinasb.common.utility.NetUtility;
...
public final class URL implements Serializable {
    ...
    public URL(String protocol, String host, int port, String[] pairs) { // 变长参数...与下面的path参数冲突，改为数组
        this(protocol, null, null, host, port, null, CollectionUtility.toStringMap(pairs));
    }
    ...
    public URL(String protocol, String host, int port, String path, String... pairs) {
        this(protocol, null, null, host, port, path, CollectionUtility.toStringMap(pairs));
    }
    ...
    public URL(String protocol, String username, String password, String host, int port,
            String path, String... pairs) {
        this(protocol, username, password, host, port, path, CollectionUtility.toStringMap(pairs));
    }
    ...
    public String getIp() {
        if (ip == null) {
            ip = NetUtility.getIpByHost(host);
        }
        return ip;
    }
    ...
    public boolean isLocalHost() {
        return NetUtility.isLocalHost(host) || getParameter(Constants.LOCALHOST_KEY, false);
    }
    ...
    public URL addParameterString(String query) {
        ...
        return addParameters(StringUtility.parseQueryString(query));
    }
    ...
    public String toIdentityString() {
        ...
        return identity = buildString(true, false); // only return identity message, see the method
                                                    // "equals" and "hashCode"
    }

    public String toIdentityString(String... parameters) {
        return buildString(true, false, parameters); // only return identity message, see the method
                                                     // "equals" and "hashCode"
    }
    ...
    private void buildParameters(StringBuilder buf, boolean concat, String[] parameters) {
        if (getParameters() != null && getParameters().size() > 0) {
            List<String> includes =
                    (parameters == null || parameters.length == 0 ? null : Arrays
                            .asList(parameters));
            boolean first = true;
    ...
    private String buildString(boolean appendUser, boolean appendParameter, boolean useIP,
            boolean useService, String... parameters) {
        StringBuilder buf = new StringBuilder();
