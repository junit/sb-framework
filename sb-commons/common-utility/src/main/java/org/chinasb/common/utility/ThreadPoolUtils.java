...
public final class ThreadPoolUtils {
        ...
        if (!executorService.isShutdown()) {
            ...
            if (LOG.isTraceEnabled()) {
                LOG.trace("Shutdown of ExecutorService: {} is shutdown: {} and terminated: {}.",
                        new Object[] {executorService, executorService.isShutdown(),
    ...
    private static void doShutdown(ExecutorService executorService, long shutdownAwaitTermination) {
        ...
        if (!executorService.isShutdown()) {
            ...
            LOG.trace("Shutdown of ExecutorService: {} with await termination: {} millis",
    ...
    public static boolean awaitTermination(ExecutorService executorService,
        ...
        while (!done && interval > 0) {
            if (executorService.awaitTermination(interval, TimeUnit.MILLISECONDS)) {
                ...
                LOG.info("Waited {} for ExecutorService: {} to terminate...",
