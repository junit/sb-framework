...
/**
 * This class is designed to process classes and interfaces that have fields marked with
...
public class ConfigurableProcessor {
     ...
     * Any object or class that have {@link Property} annotation in it or it's parent
    ...
    /**
     * This method uses recurcieve calls to launch search for {@link Property} annotation on itself
     * and parents\interfaces.
     * 
    ...
    /**
     * This method runs throught the declared fields watching for the {@link Property} annotation.
     * It also watches for the field modifiers like {@link java.lang.reflect.Modifier#STATIC} and
        ...
        for (Field f : clazz.getDeclaredFields()) {
            ...
            if (f.isAnnotationPresent(Property.class)) {
                ...
                if (Modifier.isFinal(f.getModifiers())) {
                    RuntimeException re =
                            new RuntimeException("Attempt to proceed final field " + f.getName()
    ...
    /**
     * This method takes {@link Property} annotation and does sets value according to annotation
     * property. For this reason
     * {@link #getFieldValue(java.lang.reflect.Field, java.util.Properties[])} can be called,
     * however if method sees that there is no need - field can remain with it's initial value.
     * <p/>
     * Also this method is capturing and logging all {@link Exception} that are thrown by underlying
     * methods.
     * 
    ...
    private static void processField(Field f, Object obj, Properties[] props) {
        ...
        try {
            ...
            if (!Property.DEFAULT_VALUE.equals(property.defaultValue())
                ...
                LOG.debug("Field " + f.getName() + " of class " + f.getDeclaringClass().getName()
                        + " wasn't modified");
            }
        } catch (Exception e) {
            RuntimeException re =
                    new RuntimeException("Can't transform field " + f.getName() + " of class "
     ...
     * {@link org.chinasb.common.utility.configuration.PropertyTransformerFactory}
     * 
    ...
    private static Object getFieldValue(Field field, Properties[] props)
        ...
        PropertyTransformer<?> pt =
                PropertyTransformerFactory.newTransformer(field.getType(),
