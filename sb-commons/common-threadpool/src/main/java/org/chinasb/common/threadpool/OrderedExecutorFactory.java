...
/**
 * A factory for producing executors that run all tasks in order, which delegate to a single common
 * executor instance.
 *
 * @author zhujuan
 */
public final class OrderedExecutorFactory {
    private static final Logger LOGGER = LoggerFactory.getLogger(OrderedExecutorFactory.class);
     ...
     * another call A to the same method, will result in B's task running after A's.
     */
